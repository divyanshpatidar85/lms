...
class FacultyHomeScreen extends StatefulWidget {
  List<dynamic>facultyInfo;
  
   FacultyHomeScreen({super.key,required this.facultyInfo});
                        ...
                        // ),
                                child: CircleAvatar(
                                  ...
                                  child:SizedBox(
                                    ...
                                    child: FadeInImage(
                                          placeholder:const AssetImage(
                                              'assets/app-logo/lmslogog.png'), // Placeholder image
                                          image: NetworkImage(widget.facultyInfo[5]), // Actual profile image
                                          fit: BoxFit
                            ...
                            SizedBox(
                                ...
                                child: customRowForLableAndValue(
                                  labelName: 'Username',
                                  labelValue:widget.facultyInfo[1],
                                )),
                            SizedBox(
                                width: getWidth(context) * 0.9,
                                child: customRowForLableAndValue(
                                  labelName: 'Userid',
                                  labelValue:widget.facultyInfo[2],
                                )),
                            ...
                            SizedBox(
                                ...
                                child: customRowForLableAndValue(
                                  ...
                                  labelValue:widget.facultyInfo[7].toString(),
                                ))
                          ],
                        ),
                        // width: ,
