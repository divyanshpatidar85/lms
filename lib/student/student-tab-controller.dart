...
class StudentTabController extends StatefulWidget {
  ...
  const StudentTabController({super.key, required this.userType});

  @override
  State<StudentTabController> createState() => _StudentTabControllerState();
}
...
class _StudentTabControllerState extends State<StudentTabController> {
  ...
  void initState() {
    print(
        "i am  from another side dddddddddddddddddddddddd    nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn fghvggffffffffffffffffffffffssnjnjsjjjj sbbbbb ");
  ...
  void getUserId() async {
    ...
    print("i am new user   vgvvgvvvvvvvvvvvvvvv $vali");
    studentInfo = await GetUserInformation().getInfoOfCurrentUser();
    print("i am  from another side    ssnjnjsjjjj sbbbbb ");
    setState(() {});
  }
    ...
    return studentInfo != null
        ? Scaffold(
            body: PageView(
              ...
              children: [
                StudentHomeScreen(
                  studentInfo: studentInfo == null ? [] : studentInfo!,
                ),
                BookSearch(
